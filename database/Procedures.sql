...
-- CALL GET_EMPLOYEES_BY_DEPARTMENT('Human Resources');
...
-- | department_name | job_title | pay_grade | total_employees | average_salary | permanent_employees | contract_employees |
-- | Finance | Accountant | Level-1 | 10 | 50000 | 8 | 2 |
...
-- | employee_id | name | email | job_title | pay_grade | employment_status | branch_name | experience |
DELIMITER //
